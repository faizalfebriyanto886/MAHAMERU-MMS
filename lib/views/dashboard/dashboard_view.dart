...
import 'package:mahameru/controller/dashboard/dashboard_controller.dart';
import 'package:mahameru/views/Laporan/choose_laporan_list_view.dart';
import 'package:mahameru/views/authentIcation/signin_view.dart';
import 'package:mahameru/views/cekKm/cek_km_list_view.dart';
import 'package:mahameru/views/inspeksi/inspeksi_list_view.dart';
import 'package:mahameru/views/isu/isu_list_view.dart';
                  ...
                  itemBuilder: (context, index) {
                    return SizedBox(
                      ...
                      child: ListTile(
                        ...
                        title: Text(
                          'Mon, 28 April 2022',
                          // controller.userDetail[index] == null ? "-" : controller.userDetail[index]['updated_at'],
                              ...
                              text: TextSpan(children: <WidgetSpan>[
                                ...
                                WidgetSpan(
                                  child: GestureDetector(
                                    child: Text(
                                      'admin',
                                      // controller.userDetail[index] == null ? "-" : controller.userDetail[index]['name'],
                                      style: TextStyle(
                    ...
                    child: GridView.count(
                        ...
                        children: [
                          ...
                          cardMenu(
                            ...
                            // ignore: avoid_returning_null_for_void
                            routeTo: () => Get.to(() => ChooseLaporanListView()),
                          ),
                        ],
                    )
                  ),
